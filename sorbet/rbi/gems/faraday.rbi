...
class Anonymous_Faraday_Options_34 < Faraday::Options
  def bind; end
  def bind=(_); end
  def boundary; end
  def boundary=(_); end
...
class Faraday::RequestOptions < Anonymous_Faraday_Options_34
  def []=(key, value); end
end
...
class Faraday::SSLOptions < Anonymous_Faraday_Options_35
  def disable?; end
  def verify?; end
end
class Anonymous_Faraday_Options_36 < Faraday::Options
  def password; end
  def password=(_); end
  def self.[](*arg0); end
  def self.inspect; end
...
class Faraday::ProxyOptions < Anonymous_Faraday_Options_36
...
class Anonymous_Faraday_Options_37 < Faraday::Options
  def builder; end
  def builder=(_); end
...
class Faraday::ConnectionOptions < Anonymous_Faraday_Options_37
  def builder_class; end
...
class Faraday::Env < Anonymous_Faraday_Options_38
  def [](key); end
  def []=(key, value); end
  def clear_body; end
...
class Faraday::Request < Anonymous_Struct_39
  def [](key); end
  def []=(key, value); end
  def headers=(hash); end
